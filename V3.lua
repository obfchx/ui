...
local I = Window:MakeTab({"Farming"})
local Settings = Window:MakeTab({"Main"})
local Main = Window:MakeTab({"Main"})
local M = Window:MakeTab({"Main"})
local Ss = Window:MakeTab({"Main"})
local RaceV4 = Window:MakeTab({"Main"})
local EventGame = Window:MakeTab({"Main"})
local P = Window:MakeTab({"Main"})
local Status = Window:MakeTab({"Main"})
local Visual = Window:MakeTab({"Main"})
local R = Window:MakeTab({"Main"})
local T = Window:MakeTab({"Main"})
local S = Window:MakeTab({"Main"})
local D = Window:MakeTab({"Main"})
local Misc = Window:MakeTab({"Main"})
--------------------------------------------------------------------------------------------------------
...
spawn(function()
  ...
  local Section = I:AddSection("Setting Farm")

  local DropdownSelectWeapon = I:AddDropdown({
    Name = "Select Weapon",
  ...
  task.spawn(
    ...
    local DropdownDelayAttack = I:AddDropdown({
	...
	local Section = I:AddSeperator("Farming")

    local Farm1 = I:AddToggle({"Auto Farm Level",Description = "Tự Động Cày Cấp", false, function(Value)
        _G.AutoFarm = value
    ...
    local Farm1 = I:AddToggle({"Fast Attack",Description = "Đánh Nhanh", true, function(Value)
        _G.FastAttack = value
    end)      
