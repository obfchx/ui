...
if not Success then
	warn("\nGodx Hub - Failed to load Feather Icons. Error code: " .. Response .. "\n")
end	
...
local function LoadCfg(Config)
	...
	table.foreach(Data, function(a,b)
		if OrionLib.Flags[a] then
			...
			warn("Godx Hub Config Loader - Could not find ", a ,b)
		end
	end)
end
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Gdx Hub"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Godx Hub"
