...
local ToggleLevel =Settings:AddSeperator("Settings Farming")

local ToggleLevel =Settings:AddToggle({"Bring Mob",Description = "Gôm Quái", true, function(Value)
    _G.Set = value
end)
